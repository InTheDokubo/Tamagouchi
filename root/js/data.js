...
export const CARDS_DB = [
    ...
    { id: 'overload', name: 'オーバーロード', type: 'mag', attr: 'int', val: 3.2, self_dmg: 4, desc: '魔力320%ダメージ。自分も4ダメージ（反動ではHP1未満にならない）。', icon: 'fa-broadcast-tower' },
    ...
    { id: 'world_tree', name: '世界樹の加護', type: 'buff', attr: 'hp', effect: 'world_tree', val: 25, healRate: 0.35, add_action: true, exhaust: true, rarity: 'rare', pool: 'hp', limit: 1, desc: '初回のみ最大HP+25。最大HPの35%回復、反撃5。続けて行動。[1回のみ]', icon: 'fa-tree' },
