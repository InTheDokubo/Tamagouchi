...
const UI = {
    ...
    updateBattle: () => {
        ...
        State.battle.hand.forEach((card, idx) => {
            ...
            let badges = '';
            if(card.rarity === 'rare') badges += `<span class="card-badge bg-yellow-400 text-slate-900" title="レア"><i class="fas fa-star"></i><span class="hidden md:inline">RARE</span></span>`;
