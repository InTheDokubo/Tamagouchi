...
if (!script.includes("const particleCount = lightweight ? (reignition ? 12 : 10) : (reignition ? 24 : 20)") || !html.includes('@media (max-width:767px),(pointer:coarse)')) fail('Ignition effects must use the lightweight mobile particle profile');
